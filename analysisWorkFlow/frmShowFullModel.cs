...
{
    public partial class frmShowFullModel : Form
    {
        ...
        public frmShowFullModel(String inputModel)
        {
            ...
            mnuAnalysisNetwork.Visible = false;
            mnuLoadNetwork.Visible = false;
            tabConflicts.Visible = false;
            tabInform.Visible = false;
        }



        // Load the network for analysis and display the information
        private void mnuLoadNetwork_Click(object sender, EventArgs e1)
        {
