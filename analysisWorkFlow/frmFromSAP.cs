...
{
    public partial class frmFromSAP : Form
    {
        ...
        private void btnLoad_Click(object sender, EventArgs e)
        {
            ...
            sFilePaths = loadFileDialog.FileName;
            sFileNames = loadFileDialog.SafeFileName;

            txtLoadFolder.Text = sFilePaths.Remove(loadFileDialog.FileName.Length - loadFileDialog.SafeFileName.Length);
        ...
        private void mnuMakeNetwork_Click(object sender, EventArgs e)
        {
            ...
            XmlTextReader xr = new XmlTextReader(sFilePaths);
